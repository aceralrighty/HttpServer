...
public class WebRootHandlerTest {
    ...
    @BeforeAll
    public void beforeAll() throws WebRootNotFoundException, NoSuchMethodException {
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("/Users/adamziv/Desktop/SimpleHttpServer/HttpServer/WebRoot");
    ...
    void constructorBadPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("/Users/adamziv/Desktop/SimpleHttpServer/HttpServer/WebRoot2");
            fail();
        } catch (WebRootNotFoundException e) {
        }
    }
